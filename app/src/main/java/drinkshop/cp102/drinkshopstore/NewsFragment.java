...
//                showAllNews();  //背後會去server端抓資料,show出來
    ...
    private class MyNewsRecyclerViewAdapter extends RecyclerView.Adapter<MyNewsRecyclerViewAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
            ...
            myViewHolder.tvActivityName.setText(news.getActivityName());
            myViewHolder.tvActivityDateStart.setText(news.getActivityDateStart());
            myViewHolder.tvActivityDateEnd.setText(news.getActivityDateEnd());
