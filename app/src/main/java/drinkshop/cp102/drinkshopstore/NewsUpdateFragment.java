...
public class NewsUpdateFragment extends Fragment {
     ...
     dataBindViews();
        ...
        btFinishUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                News newNews = new News(news.getId(), activityName, activityDateStart,activityDateEnd); //比insert多了一個id
    ...
    private void dataBindViews() {
        ...
        etActivityName.setText(news.getActivityName());
        etActivityDateStart.setText(news.getActivityDateStart());
        etActivityDateEnd.setText(news.getActivityDateEnd());
    }
